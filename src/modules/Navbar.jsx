  ...
  return (
    ...
    <nav className="bg-white border-gray-200 navb">
        <div className="flex flex-wrap items-center justify-around mx-auto p-4">
          <NavLink to="/" className="text-white fw-bolder text-3xl ">
            START REACT
          </NavLink>
          <button
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul className="font-medium flex items-center flex-col p-4 md:p-0 mt-4 border rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 ">
              <li>
                <NavLink
                  to="Portfolio"
                  className=" a flex items-center justify-center  text-white shadow-2xl shadow-gray-800"
                >
                  {" "}
                  PORTFOLIO
                </NavLink>
              ...
              <li>
                <NavLink
                  to="About"
                  className=" a flex items-center justify-center text-white py-4 shadow-2xl shadow-gray-800"
                >
                  {" "}
                  ABOUT
                </NavLink>
